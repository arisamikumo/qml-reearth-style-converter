...
## 現状と今後について
このプラグインは 2026年4月時点でQGISの段階スタイル（Graduated）を中心に動作確認しています。
...
### 次にやりたいこと
- 分類スタイル（Categorized）の動作確認と改善 — QGISで属性値ごとに色分けしたスタイルをきちんと変換できるようにしたい。実際に試してみてフィードバックをもらえると助かります！
- ライン・ポイントジオメトリのテスト強化
- ルールベーススタイルへの対応
- バグや未対応ケースを見つけたら → Issue を立ててください
